<?php
/**
 * Gestión de Métodos de Pago - Forrajería
 * 
 * Módulo para listar y crear nuevos métodos de pago en el sistema.
...
<head>
    ...
    <title>Métodos de Pago - Forrajería</title>
    <!-- Assets locales -->
...
<body class="bg-gray-100">
    <div class="flex min-h-screen dashboard-layout">
        <!-- Sidebar -->
        <?= renderSidebar('config_metodos_pago', $userRole); ?>
        
        <!-- Contenido principal -->
        <main class="flex-1 flex flex-col">
            <!-- Header -->
            <?= renderHeader('Métodos de Pago', 'Gestión de opciones de cobro y medios de pago', $userName, $userRole); ?>
            ...
            <div class="flex-1 p-6 overflow-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <!-- Formulario de creación de método de pago -->
                    <div class="lg:col-span-1 bg-white rounded-xl shadow-sm p-6 border border-gray-100 h-fit">
                        ...
                        <form id="formMetodoPago" novalidate>
                            <div class="mb-4 form-group">
                                <label for="nombre" class="block text-sm font-medium text-gray-700 mb-1">Nombre del Método de Pago *</label>
                                <input type="text" 
                                       name="nombre" 
                                       id="nombre" 
